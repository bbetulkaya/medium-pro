...
export default function Post({
  ...
  return (
    <>
      <div>
        <div>{!cover && (<div>create a tmp image for this post</div>)}</div>
        <div>{title}</div>
        <div>{summary}</div>
        ...
        <div className="grid grid-cols-[0.8fr,1fr] gap-4 mb-8">
          ...
          <div className="post-text">
            ...
            <p className="my-2 font-thin">
              As a front-end development engineer, you must have used many tools
              to increase your productivity. They can be websites,
              documentation, or a JavaScript library.
            </p>
          </div>
        </div>
      )}
